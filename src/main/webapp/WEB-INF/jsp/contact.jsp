...
<head>
    ...
    <title>Contact - Dhreeti Kumar Sahoo</title>
...
<header class="bg-primary text-white text-center py-5">
  <div class="container slide-down" style="animation-delay:0.2s">
    ...
    <p class="lead">Let's connect and discuss opportunities</p>
  </div>
</header>
      ...
      <div class="card shadow border-0">
        <div class="card-body p-5">
          ...
          <div class="mt-4 text-center">
            ...
            <p><strong>Email:</strong> sahoodhreetikumar@gmail.com</p>
            <p><strong>Phone:</strong> +91 9337636068</p>
